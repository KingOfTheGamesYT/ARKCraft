...
import com.uberverse.arkcraft.deprecated.ARKCraftingManager;
import com.uberverse.arkcraft.deprecated.ARKPlayer;
import com.uberverse.arkcraft.deprecated.IARKRecipe;
...
public class InventoryBlueprints extends InventoryBasic
{
	...
	public InventoryBlueprints(String title, boolean customName, int slotCount, ARKCraftingManager craftingManager, InventoryPlayerCrafting invCrafting, short craftTimeForItem)
	{
		super(title, customName, slotCount);
	...
	// We do not save the blueprint inventory to NBT, it is loaded from the
	// Crafting Manager

	/**
	 * Do not give this method the name canInteractWith because it clashes with
	 * Container
	 */
	...
	// Warning: numThatCanBeCrafted is only set on client when this is called,
	// but crafting logic takes this into account
	...
	// This method is called every tick to update the tile entity (called from
	// PlayerTickEvent)
	...
	public void update()
	{
		...
		// LogHelper.info("InventoryBlueprints: Update called on " +
		// FMLCommonHandler.instance().getEffectiveSide());
	...
	public int getxButtonPressed()
	{
		return xButtonPressed;
	}

	public void setxButtonPressed(int xButtonPressed)
	{
		this.xButtonPressed = xButtonPressed;
	}
	...
	public int getyButtonPressed()
	{
		return yButtonPressed;
	}

	public void setyButtonPressed(int yButtonPressed)
	{
		this.yButtonPressed = yButtonPressed;
	}
}
