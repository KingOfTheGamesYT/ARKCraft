...
public abstract class ItemRangedWeapon extends ItemBow implements IMeshedItem
{
    ...
    public void soundCharge(ItemStack stack, World world, EntityPlayer player)
    {
        ...
        // String name = ARKCraft.MODID + ":" + this.getUnlocalizedName() +
        // "_reload";
    ...
    public void effectShoot(EntityPlayer p, ItemStack stack, World world, double x, double y, double z, float yaw, float pitch)
    {
        ...
        // world.playSoundEffect(x, y, z, SoundEvent.REGISTRY.getObject(new
        // ResourceLocation(soundPath), 1.5F, 1F /
        // (this.getItemRand().nextFloat() * 0.4F + 0.7F));
        // world.playSound(entityplayer, entityplayer.getPosition(),
        // SoundEvent.REGISTRY.getObject(new ResourceLocation(soundPath),
        // SoundCategory.PLAYERS, 1.5F, 1F / (this.getItemRand().nextFloat() *
        // 0.4F + 0.7F));
        // SoundUtil.playSound(world, x, y, z, new ResourceLocation(soundPath),
        // SoundCategory.PLAYERS, 1.5F, 1F / (this.getItemRand().nextFloat() *
        // 0.4F + 0.7F), false);
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot, ItemStack stack)
    {
        ...
        return multimap;
        //TODO replace with addInformation
    }
