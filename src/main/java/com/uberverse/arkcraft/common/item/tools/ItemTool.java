...
public class ItemTool extends Item
{
    ...
    public String getItemStackDisplayName(ItemStack stack)
    {
        ...
        case RAMSCHACKLE:
            return (ChatFormatting.GREEN + "" + I18n.format(this.getUnlocalizedNameInefficiently(stack) + ".name")).trim();
        case APPRENTICE:
            return (ChatFormatting.BLUE + "" + I18n.format(this.getUnlocalizedNameInefficiently(stack) + ".name")).trim();
        case JOURNEYMAN:
            return (ChatFormatting.DARK_PURPLE + "" + I18n.format(this.getUnlocalizedNameInefficiently(stack) + ".name")).trim();
        case MASTERCRAFT:
            return (ChatFormatting.YELLOW + "" + I18n.format(this.getUnlocalizedNameInefficiently(stack) + ".name")).trim();
        case ASCENDANT:
            return (ChatFormatting.RED + "" + I18n.format(this.getUnlocalizedNameInefficiently(stack) + ".name")).trim();
        default:
            break;
        }
