...
public class ContainerInventoryCampfire extends Container
{
	...
	public void detectAndSendChanges()
	{
		...
		boolean fieldHasChanged[] = new boolean[tileInventoryCampfire.getFieldCount()];
		...
		{
			if (allFieldsHaveChanged || cachedFields[i] != tileInventoryCampfire.getField(i))
			{
		...
		for (int i = 0; i < this.crafters.size(); ++i)
		{
			...
			for (int fieldID = 0; fieldID < tileInventoryCampfire.getFieldCount(); ++fieldID)
			{
