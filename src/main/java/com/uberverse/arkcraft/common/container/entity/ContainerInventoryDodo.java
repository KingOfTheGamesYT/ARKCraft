package com.uberverse.arkcraft.common.container.entity;
...
public class ContainerInventoryDodo extends Container
{
    ...
    public ContainerInventoryDodo(IInventory invPlayer, final InventoryDino invDodo, final EntityDodo dodo)
    {
    ...
    public void addListener(IContainerListener listener)
    {
        ...
        listener.updateCraftingInventory(this, invDodo.getInventoryStacks());
    }
    ...
    {
        return this.invDodo.isUsableByPlayer(playerIn) && this.dodo.isEntityAlive() && this.dodo.getDistanceToEntity(playerIn) < 8.0F;
    }
