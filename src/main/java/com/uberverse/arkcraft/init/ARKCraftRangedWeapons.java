...
public class ARKCraftRangedWeapons
{
	...
	public static void addRangedWeapons()
	{
		...
		if (ModuleItemBalance.WEAPONS.LONGNECK_RIFLE)
		{
			...
			longneck_rifle = init.registerItem("longneck_rifle", "weapons/", new ItemLongneckRifle(), "longneck_rifle", "longneck_rifle_scope",
					"longneck_rifle_scope_reload", "longneck_rifle_reload", "longneck_rifle_flashlight", "longneck_rifle_flashlight_reload",
					"longneck_rifle_laser", "longneck_rifle_laser_reload", "longneck_rifle_silencer", "longneck_rifle_silencer_reload");
		...
		if (ModuleItemBalance.WEAPONS.SIMPLE_PISTOL)
		{
			simple_pistol = init.registerItem("simple_pistol", "weapons/", new ItemSimplePistol(), "simple_pistol", "simple_pistol_scope",
					"simple_pistol_reload", "simple_pistol_scope_reload", "simple_pistol_flashlight", "simple_pistol_flashlight_reload",
					"simple_pistol_laser", "simple_pistol_laser_reload", "simple_pistol_silencer", "simple_pistol_silencer_reload");
		...
		if (ModuleItemBalance.WEAPONS.FABRICATED_PISTOL)
		{
			fabricated_pistol = init.registerItem("fabricated_pistol", "weapons/", new ItemFabricatedPistol(), "fabricated_pistol",
					"fabricated_pistol_scope", "fabricated_pistol_reload", "fabricated_pistol_scope_reload", "fabricated_pistol_flashlight",
					"fabricated_pistol_flashlight_reload", "fabricated_pistol_laser", "fabricated_pistol_laser_reload", "fabricated_pistol_silencer",
					"fabricated_pistol_silencer_reload", "fabricated_pistol_holo_scope", "fabricated_pistol_holo_scope_reload");
