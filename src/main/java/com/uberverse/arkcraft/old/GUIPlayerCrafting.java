...
public class GUIPlayerCrafting extends GuiContainer
{
	...
	public static final ResourceLocation texture = new ResourceLocation(ARKCraft.MODID,
			"textures/gui/player_inventory_gui.png");
	...
	public GUIPlayerCrafting(InventoryPlayer invPlayer, EntityPlayer player)
	{
		...
		LogHelper.info("GuiPlayerCrafting: Constructor called on " + FMLCommonHandler.instance()
				.getEffectiveSide());
	...
	public void initGui()
	{
		...
		for (int row = 0; row < ContainerInventoryPlayerCrafting.NUM_ROWS_BP; row++)
		{
			for (int col = 0; col < ContainerInventoryPlayerCrafting.NUM_COLUMNS_BP; col++)
			{
				...
				buttonCraftOne[i] = new GuiButton(buttonId++, guiLeft + x, guiTop + y,
		...
		engramButton = new GuiButton(
				ContainerInventoryPlayerCrafting.NUM_ROWS_BP * ContainerInventoryPlayerCrafting.NUM_COLUMNS_BP,
				...
				for (int col = 0; col < ContainerInventoryPlayerCrafting.NUM_COLUMNS_BP; col++)
				{
					...
					if (button == buttonCraftOne[i])
					{
						...
						inventoryBlueprints.setxButtonPressed(
								ContainerInventoryPlayerCrafting.BLUEPRINT_XPOS + col * 18);
						inventoryBlueprints.setyButtonPressed(
								ContainerInventoryPlayerCrafting.BLUEPRINT_YPOS + row * 18);
					}
				}
			}
		}
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		// ContainerInventoryPlayerCrafting.NUM_ROWS_BP; row++)
		// {
		// for (int col = 0; col <
		// ContainerInventoryPlayerCrafting.NUM_COLUMNS_BP; col++, i++)
		// {
		...
		// break;
		// }
		// int x = guiLeft + ContainerInventoryPlayerCrafting.BLUEPRINT_XPOS +
		// col * 18;
		// int y = guiTop + ContainerInventoryPlayerCrafting.BLUEPRINT_YPOS +
		// row * 18;
		// if (isInRect(x, y, BLUEPRINT_WIDTH, BLUEPRINT_HEIGHT, mouseX,
		// mouseY))
		// {
		// ItemStack stack = inventoryBlueprints.getStackInSlot(i);
		// List recipeList =
		// PlayerCraftingManager.getInstance().getRecipeList();
		...
		// hoveringText.add(I18n.format("arkcraft.tooltip.ingredient",
		...
		// hoveringText.add(itemName + " - Can craft " +
		// inventoryBlueprints.getNumToBeCrafted(i));
		// // Exit loops
		// row = ContainerInventoryPlayerCrafting.NUM_ROWS_BP;
		// break; */
		// }
