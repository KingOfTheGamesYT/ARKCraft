package com.uberverse.arkcraft.wip.blueprint.ex;
...
public class ChessboardSmartItemModel implements ISmartItemModel
{
	...
	public List<BakedQuad> getChessPiecesQuads(int numberOfPieces)
	{
		...
		TextureAtlasSprite chessPieceTexture = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite("minecraft:blocks/diamond_block");
		...
		if (numberOfPieces < MIN_NUMBER_OF_PIECES || numberOfPieces > MAX_NUMBER_OF_PIECES) { return returnList; }
