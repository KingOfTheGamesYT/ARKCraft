...
public class ClientUtils
{
    ...
    public static void drawGradientRect(int left, int top, int right, int bottom, int startColor, int endColor)
    {
        ...
        buffer.color(f1, f2, f3, f).pos(right, top, zLevel).endVertex();
        buffer.color(f1, f2, f3, f).pos(left, top, zLevel).endVertex();
        buffer.color(f5, f6, f7, f4).pos(left, bottom, zLevel).endVertex();
        buffer.color(f5, f6, f7, f4).pos(right, bottom, zLevel).endVertex();
        tessellator.draw();
        // END TODO
