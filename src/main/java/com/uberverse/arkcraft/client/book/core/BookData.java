...
public class BookData
{
	...
	public ResourceLocation leftPage = new ResourceLocation(ARKCraft.MODID,
			"textures/gui/info_book_left.png");
	public ResourceLocation rightPage = new ResourceLocation(ARKCraft.MODID,
			"textures/gui/info_book_right.png");

	public ResourceLocation itemImage = new ResourceLocation(ARKCraft.MODID,
