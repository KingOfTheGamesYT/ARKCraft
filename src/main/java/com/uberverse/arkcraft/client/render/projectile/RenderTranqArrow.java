...
public class RenderTranqArrow extends Render
{
	...
	public void doRender(EntityTranqArrow p_180551_1_, double p_180551_2_, double p_180551_4_, double p_180551_6_,
	...
	{
		doRender((EntityTranqArrow) entity, d, d1, d2, f, f1);
	}
