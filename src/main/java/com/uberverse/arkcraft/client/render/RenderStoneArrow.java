...
{
    private static final ResourceLocation texture = new ResourceLocation(ARKCraft.MODID, "textures/entity/stoneArrow.png");
    ...
    protected ResourceLocation getEntityTexture(EntityStoneArrow p_180550_1_)
    {
        return texture;
    }
    ...
    {
        return this.getEntityTexture((EntityStoneArrow) entity);
    }
    ...
    {
        this.doRender((EntityStoneArrow) entity, x, y, z, p_76986_8_, partialTicks);
    }
}