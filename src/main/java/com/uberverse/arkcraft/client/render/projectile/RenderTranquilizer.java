...
public class RenderTranquilizer extends Render<EntityTranquilizer>
{
	...
	@Override
	public void doRender(EntityTranquilizer entityarrow, double d, double d1, double d2, float f, float f1)
	{
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityTranquilizer entity)
	{
