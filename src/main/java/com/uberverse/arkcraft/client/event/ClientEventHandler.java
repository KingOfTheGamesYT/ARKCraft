...
public class ClientEventHandler
{
    ...
    public void onPlayerKeypressed(InputEvent.KeyInputEvent event)
    {
        ...
        if (playerPooping.isPressed()) {
            ...
            if (player.getActiveItemStack() != null && player.getActiveItemStack().getItem() instanceof ItemRangedWeapon && !(player.getActiveItemStack().getItem() instanceof NonSupporting)) {
