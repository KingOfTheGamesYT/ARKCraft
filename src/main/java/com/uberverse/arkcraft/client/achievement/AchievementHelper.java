...
public class AchievementHelper
{
	...
	public static void registerAchievement(EntityPlayer player,
	...
	public static void registerAchievement(EntityPlayer player,
			AchievementPage page, Achievement achievement)
	{
		page.getAchievements().add(achievement);
		player.addStat(achievement, 1);
	}

	public static void registerAndDisplay(EntityPlayer player,
			Achievement achievement)
	{
	...
	public static boolean containsAchievement(AchievementPage page,
			Achievement achievement)
	{
