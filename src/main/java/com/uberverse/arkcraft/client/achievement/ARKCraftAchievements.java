...
public class ARKCraftAchievements 
{
	...
	{
		achievementMichaelBay = new Achievement("achievement.michaelBay", "theBigBang", 0, 0, ARKCraftRangedWeapons.rocket_propelled_grenade, (Achievement) null).setSpecial();
