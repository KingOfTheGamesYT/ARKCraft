...
import com.arkcraft.common.arkplayer.PlayerWeightCalculator;
import com.arkcraft.common.config.WeightsConfig;
import com.arkcraft.common.inventory.InventoryAttachment;
import com.arkcraft.common.item.attachments.NonSupporting;
		...
		if (evt.getType() == RenderGameOverlayEvent.ElementType.CROSSHAIRS && (stack != null && stack.getItem() instanceof ItemRangedWeapon))
			...
			if (mop != null && mop.typeOfHit == RayTraceResult.Type.BLOCK) {
				...
				if (tile instanceof IHoverInfo) {
					ClientUtils.drawIHoverInfoTooltip((IHoverInfo) tile, mc.fontRenderer, evt, mop.getBlockPos());
				}
			}
		}
	}
