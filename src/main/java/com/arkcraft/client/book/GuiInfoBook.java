package com.arkcraft.client.book;
...
import com.arkcraft.client.book.lib.button.PageButton;
...
public class GuiInfoBook extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		nButton.drawButton(Minecraft.getMinecraft(), mouseX, mouseY, partialTicks);
		prevButton.drawButton(Minecraft.getMinecraft(), mouseX, mouseY, partialTicks);
