package com.arkcraft.client.book.lib;
...
/**
 * Font Renderer from Mantle library
 * https://github.com/SlimeKnights/Mantle/blob/d997586c8cb2bc92c09191dd834becfc740fdaab/src/mantle/client/SmallFontRenderer.java
 * 
 */
        ...
        for (int i = 0; i < par1Str.length(); ++i) {
            ...
            if (c0 == 167 && i + 1 < par1Str.length()) {
                ...
                if (this.randomStyle && j > 0) {
                    do {
                        //TODO make new array of allowed characters
...
//                    TODO again worldrenderer -- to be fixed
//                    WorldRenderer wr = Tessellator.getInstance().getWorldRenderer();
//                    GL11.glDisable(GL11.GL_TEXTURE_2D);
//                    wr.startDrawingQuads();
//                    wr.addVertex((double) this.posX, (double) (this.posY + (float) (this.FONT_HEIGHT / 2)), 0.0D);
//                    wr.addVertex((double) (this.posX + f1), (double) (this.posY + (float) (this.FONT_HEIGHT / 2)), 0.0D);
//                    wr.addVertex((double) (this.posX + f1), (double) (this.posY + (float) (this.FONT_HEIGHT / 2) - 1.0F), 0.0D);
//                    wr.addVertex((double) this.posX, (double) (this.posY + (float) (this.FONT_HEIGHT / 2) - 1.0F), 0.0D);
//                    Tessellator.getInstance().draw();
//                    GL11.glEnable(GL11.GL_TEXTURE_2D);
                }

                if (this.underlineStyle) {
                    //TODO worldrenderer to be fixed
//                    WorldRenderer wr = Tessellator.getInstance().getWorldRenderer();
//                    GL11.glDisable(GL11.GL_TEXTURE_2D);
//                    wr.startDrawingQuads();
//                    int l = this.underlineStyle ? -1 : 0;
//                    wr.addVertex((double) (this.posX + (float) l), (double) (this.posY + (float) this.FONT_HEIGHT), 0.0D);
//                    wr.addVertex((double) (this.posX + f1), (double) (this.posY + (float) this.FONT_HEIGHT), 0.0D);
//                    wr.addVertex((double) (this.posX + f1), (double) (this.posY + (float) this.FONT_HEIGHT - 1.0F), 0.0D);
//                    wr.addVertex((double) (this.posX + (float) l), (double) (this.posY + (float) this.FONT_HEIGHT - 1.0F), 0.0D);
//                    Tessellator.getInstance().draw();
//                    GL11.glEnable(GL11.GL_TEXTURE_2D);
                }
