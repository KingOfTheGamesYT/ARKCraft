...
{
	public static final ResourceLocation scrollButtonCreativeResource = new ResourceLocation(
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		this.drawTexturedModalRect(guiLeft + getScrollBarStartX(), y, canScroll() ? getScrollButtonU()
				: getScrollButtonDisabledU(), canScroll() ? getScrollButtonV() : getScrollButtonDisabledV(),
