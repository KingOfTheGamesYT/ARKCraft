...
public class ContainerInventoryDodo extends Container {
	...
	public void addListener(IContainerListener listener) {
		...
		listener.sendAllContents(this, invDodo.getInventoryStacks());
	}
	...
	public boolean canInteractWith(EntityPlayer playerIn) {
		return this.invDodo.isUsableByPlayer(playerIn) && this.dodo.isEntityAlive() && this.dodo.getDistance(playerIn) < 8.0F;
	}
