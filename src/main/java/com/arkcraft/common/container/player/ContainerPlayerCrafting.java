...
public class ContainerPlayerCrafting extends ContainerEngramCrafting
{
	...
	{
		super(EngramManager.EngramType.PLAYER, player, ARKPlayer.get(player).getEngramCrafter());
	}
	...
	public boolean enchantItem(EntityPlayer playerIn, int id)
	{
		if (id == 2)
		{
			playerIn.openGui(ARKCraft.instance(), CommonProxy.GUI.ENGRAMS.id, playerIn.world, 0, 0, 0);
			return true;
		}
