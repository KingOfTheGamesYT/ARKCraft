...
public class EntityHandler {
	...
	public static void registerMonster(Class eClass, String name, Biome... biomes) {
		...
		EntityRegistry.registerModEntity(new ResourceLocation(ARKCraft.MODID, name), eClass, name, idCount++, ARKCraft.instance(), 10, 1, false, mainColor, secondColor);
	...
	public static void registerModEntity(Class<? extends Entity> eClass, String name, Object mod, int trackRange, int updateFreq, boolean sVU) {
		EntityRegistry.registerModEntity(new ResourceLocation(ARKCraft.MODID, name), eClass, name, ++entityID, mod, trackRange, updateFreq, sVU);
	}
}
