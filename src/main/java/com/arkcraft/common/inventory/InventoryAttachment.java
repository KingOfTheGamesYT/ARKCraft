package com.arkcraft.common.inventory;

import com.arkcraft.common.item.attachments.*;
...
public class InventoryAttachment extends AbstractInventory {
	 ...
	 */
	//TODO rework to ItemStack.EMPTY
	...
	public void markDirty() {
		...
		for (int i = 0; i < getSizeInventory(); ++i) {
			if (getStackInSlot(i) != null && getStackInSlot(i).isEmpty()) inventory[i] = null;
		}
